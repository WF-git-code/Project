...
public:
	...
	:TaskList(Tasksize,Task_waittime),MaxThreadSize(maxthread),Core_ThreadSize(coretsize),All_ThreadSize(0),Free_ThreadSize(0),Running(false),Thread_Wait_Time(thread_waittime)
	{
		Start(coretsize);
	}
	~CachedThreadPool() {
